...
class AlgoliaSettings {
  ...
  AlgoliaSettings setSortFacetValuesBy(AlgoliaSortFacetValuesBy value) {
    ...
    return _copyWithParameters(<String, dynamic>{
      'sortFacetValuesBy': value.toString().substring(value.toString().indexOf('.') + 1)
    });
  }
  ...
  AlgoliaSettings setAroundRadius(dynamic value) {
    ...
    assert(
        (value is int || (value is String && value == 'all')), 'value must be a `int` or `"all"`');
  ...
  AlgoliaSettings setDecompoundedAttributes(List<DecompoundedAttribute> value) {
    ...
    for (var attr in value) {
      list =
          Map<String, dynamic>.unmodifiable(Map<String, dynamic>.from(list)..addAll(attr.toMap()));
    }
  ...
  AlgoliaSettings setRemoveWordsIfNoResults(RemoveWordsIfNoResults value) {
    ...
    return _copyWithParameters(
        <String, dynamic>{'removeWordsIfNoResults': value.toString().split('.').last});
  }
  ...
  AlgoliaSettings setExactOnSingleWordQuery(ExactOnSingleWordQuery value) {
    ...
    return _copyWithParameters(
        <String, dynamic>{'exactOnSingleWordQuery': value.toString().split('.').last});
  }
